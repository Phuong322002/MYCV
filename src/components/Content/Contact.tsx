            ...
            <div className="arlo_tm_section" id="contact">
                ...
                <div className="arlo_tm_footer_contact_wrapper_all">
                        ...
                        <div className="container">
                            <div className="leftbox">
                                ...
                                <div className="short_info_wrap">
                                    <ul>
                                        <li><p><label>Email:</label><span><a href="mailto:puong334@gmail.com">puong334@gmail.com</a></span></p></li>
                                        <li><p><label>Github:</label><span><a href="https://github.com/Phuong322002 " target="_blank">Phuong322002</a></span></p></li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div className="arlo_tm_footer_wrap">
                        <div className="container">
                            <p>&copy; Copyright 2024 by Phuong. All Rights are Reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
